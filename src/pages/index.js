...
const IndexPage = () => {
    ...
    return (
        <Layout>
            ...
            <Footer><a href="//tomgordon.me" rel="noopener noreferrer" target="_blank"><span role="img" aria-label="pig emoji">🐷</span> tom made this <span role="img" aria-label="pig emoji">🐷</span></a></Footer>
        </Layout>
    )
}
